...
//           {/* Contact Info */}
//           <motion.div
//             className="bg-white/40 dark:bg-white/5 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-white/20 flex flex-col items-start"
...
//               <div className="flex items-center space-x-3 hover:text-indigo-600 transition">
//                 <Phone className="w-5 h-5" />
//                 <span>+91- 9554019387</span>
//               </div>

//               <div className="flex items-center space-x-3 hover:text-green-500 hover:scale-[1.02] transition-all duration-200">
//                 <FaWhatsapp className="w-5 h-5" />
//                 <a href="https://wa.me/+919554019387" target="_blank" rel="noreferrer">
//                   WhatsApp Chat
//                 </a>
//               </div>
...
//                 <a href="mailto:aryan07vns@gmail.com">aryan07vns@gmail.com</a>
//               </div>
              
//               <div className="flex items-center space-x-3 hover:text-indigo-600 transition">
//                 <FaLinkedin className="w-5 h-5" />
//                 <a href="https://linkedin.com/in/imanuj-arya/" target="_blank" rel="noreferrer">
//                   Connect with me on LinkedIn
//                 </a>
//               </div>
//               <div className="flex items-center space-x-3 hover:text-indigo-600 transition">
//                 <Github className="w-5 h-5" />
//                 <a href="https://github.com/anuj2810" target="_blank" rel="noreferrer">
//                   GitHub Profile
//                 </a>
//               </div>
//               <div className="flex items-center space-x-3 hover:text-indigo-600 transition">
//                 <FaXTwitter className="w-5 h-5" />
//                 <a href="https://x.com/aryan07mzp" target="_blank" rel="noreferrer">
...
//             <div>
//               <label className="block text-gray-700 dark:text-gray-300 font-medium mb-1">Phone (optional)</label>
//               <input
//                 type="tel"
//                 name="phone"
...
//           .then((data) => {
//             if (!data.success) {
//               toast.warning("⚠️ SMS not sent: " + data.error);
//             }
//           })
//           .catch((err) => {
//             console.error("SMS error:", err);
